...
- resolved_at: 2026-04-27T13:00:30.310513+00:00
- **status: pass**
...
| table | `tbl_since_last_review` | direct_workbook_table | pass | sheet=Q1 Movement cols=4 |
...
| table | `tbl_top_open_opportunities` | direct_workbook_table | pass | sheet=Pipeline Open FY26 cols=8 |
...
| table | `tbl_deal_risk_triage` | direct_workbook_table | pass | sheet=Pipeline Inspection cols=8 |
...
| table | `tbl_owner_coaching` | direct_workbook_table | pass | sheet=Pipeline Open FY26 cols=6 |
...
| table | `tbl_forecast_mix` | direct_workbook_table | pass | sheet=Commit Items cols=3 |
...
| table | `tbl_approvals_pending` | direct_workbook_table | pass | sheet=Commercial Approval cols=4 |
| table | `tbl_approvals_candidate` | direct_workbook_table | pass | sheet=Commercial Approval cols=3 |
| table | `tbl_approvals_other` | direct_workbook_table | pass | sheet=Commercial Approval cols=2 |
