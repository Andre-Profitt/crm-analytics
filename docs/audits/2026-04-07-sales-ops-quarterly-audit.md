...
- **Dashboard lastModifiedDate:** 2026-04-07T12:52:00Z
...
- **Tally:** 35 entries . 23 BLOCKING . 8 WRONG-DATA . 4 ORPHAN
...
| WRONG-DATA | No Activity 30 Plus Days | (orphan) | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. | Fix the static rule issue AND decide keep/drop/fold. See static rule detail. |
...
| WRONG-DATA | Aging Pipeline 365 Plus Days | Pipeline hygiene (aging) | Pipeline widget aggregates on standard AMOUNT (`AMOUNT`). Brief requires APTS_Opportunity_ARR__c for ARR. | See static rule detail |
...
| 24 | Low Probability In Quarter | Report | 01aTb00000CmjwzIAB | 00OTb000008RfKDMA0 | Low Probability In Quarter | SUMMARY | THIS_FISCAL_QUARTER | 11.48M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_QUARTER but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 25 | Missing Amount on Open Opps | Report | 01aTb00000CmjwwIAB | 00OTb000008TZqcMAG | Missing Amount | TABULAR | THIS_FISCAL_YEAR | 773 |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 26 | Missing Decision Reason | Report | 01aTb00000CmjwnIAB | 00OTb000008el0PMAQ | Missing Decision Reason | SUMMARY | THIS_FISCAL_YEAR | 28.79M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year.; Widget is 'Missing decision reason' but the field is not in the detail columns |
| 27 | No Activity 30 Plus Days | Report | 01aTb00000CmjwyIAB | 00OTb000008TaEnMAK | No Activity 30+ Days — Open Opps | SUMMARY | THIS_FISCAL_YEAR | 1214.99M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 28 | Stale Opportunities | Report | 01aTb00000CmjwvIAB | 00OTb000008TZgvMAG | Stale Opportunities | TABULAR | THIS_FISCAL_YEAR | 1.3K |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 29 | Under Construction: Probability Mismatch by Stage | Report | 01aTb00000CmjwpIAB | 00OTb000008TaJdMAK | Probability Mismatch by Stage | SUMMARY | THIS_FISCAL_YEAR | 1001.90M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 30 | Won Loss Info Missing CFQ | Report | 01aTb00000CmjwsIAB | 00OTb000008SqblMAC | Won/Loss Info Missing CFQ | SUMMARY | THIS_FISCAL_QUARTER | 3.45M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_QUARTER but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 31 | Aging Pipeline 365 Plus Days | Report | 01aTb00000CmjwqIAB | 00OTb000008Ti7VMAS | Aging Pipeline 365 Plus Days | SUMMARY | CUSTOM | 2164.51M | ph_aging_pipeline_365_plus | Pipeline hygiene (aging) | WRONG-DATA | Pipeline widget aggregates on standard AMOUNT (`AMOUNT`). Brief requires APTS_Opportunity_ARR__c for ARR. |
| 32 | High Value Stale Deals | Report | 01aTb00000Cmjx0IAB | 00OTb000008Ti97MAC | High Value Stale Deals | TABULAR | CUSTOM | 22.03M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 33 | KYC Not Completed | Report | 01aTb00000CmjwxIAB | 00OTb000007BvlJMAS | KYC Not Completed | SUMMARY | CUSTOM | 0 |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 34 | Overdue Close Date Open Opps | Report | 01aTb00000CmjwtIAB | 00OTb000008TaBZMA0 | Overdue Close Date | TABULAR | CUSTOM | 122 |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 35 | Overdue Opportunities | Report | 01aTb00000CmjwoIAB | 00OTb000008SrmLMAS | Overdue Opportunities | SUMMARY | CUSTOM | 2.4K |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
