...
- **Dashboard lastModifiedDate:** 2026-04-08T23:43:18Z
...
- **Tally:** 22 entries . 7 BLOCKING . 15 OK
...
| OK | Commercial Approval Current State | Commercial Approval overview (global, current state) | Matches spec and passes static rules | n/a |
...
| OK | Pipeline Overview by Stage | Pipeline overview with quarterly focus | Matches spec and passes static rules | n/a |
...
| OK | Renewal Likelihood by Probability | Renewals tracking | Matches spec and passes static rules | n/a |
| OK | Renewals by Quarter | Renewals tracking | Matches spec and passes static rules | n/a |
...
| 6 | (MISSING) renewal_upcoming_list | table |  |  |  |  |  |  | renewal_upcoming_list | Renewals tracking | BLOCKING | Spec requires this widget; dashboard does not have it |
| 7 | (MISSING) slipped_deals_trend | chart |  |  |  |  |  |  | slipped_deals_trend | Slipped deals analysis | BLOCKING | Spec requires this widget; dashboard does not have it |
| 8 | Business At Risk | Report | 01aTb00000Cn85dIAB | 00OTb000008Ta9xMAC | Business At Risk | SUMMARY | CUSTOM | 641.18M | churn_risk_placeholder | Churn Risk and trends | OK | Matches spec and passes static rules |
| 9 | Commercial Approval Candidates by Stage | Report | 01aTb00000Cn85jIAB | 00OTb000008ekp7MAA | Commercial Approval Candidates | SUMMARY | CUSTOM | 34.71M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 10 | Land Stage 3 Missing Approval by Region | Report | 01aTb00000Cn85hIAB | 00OTb000008ekltMAA | Land Stage 3 Missing Approval | SUMMARY | CUSTOM | 34.67M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 11 | New Customers (Land) by Region | Report | 01aTb00000Cn85cIAB | 00OTb000008ekqjMAA | New Customers (Land) by Region | SUMMARY | THIS_YEAR | 1.92M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 12 | Commercial Approval Approved YTD (Land) | Report | 01aTb00000Cn8FFIAZ | 00OTb000008aTtJMAU | Commercial Approval approved 2026 | SUMMARY | CUSTOM | 18.94M | commercial_approval_approved_ytd | Commercial Approval overview (global, YTD approved) | OK | Matches spec and passes static rules |
| 13 | Commercial Approval Current State | Report | 01aTb00000Cn9mQIAR | 00OTb000008fBEDMA2 | P2.7 Commercial Approval Global | SUMMARY | CUSTOM | 1.8K | commercial_approval_global | Commercial Approval overview (global, current state) | OK | Matches spec and passes static rules |
| 14 | Forecast Accuracy | Report | 01aTb00000Cn85iIAB | 00OTb000008TZsDMAW | Forecast Accuracy | MATRIX | THIS_YEAR | 23.37M | forecast_accuracy_snapshot | Forecast accuracy (handbook-derived) | OK | Matches spec and passes static rules |
| 15 | Forecast and Closed Won | Report | 01aTb00000Cn85gIAB | 00OTb000008TZaTMAW | Forecast & Closed Won | SUMMARY | THIS_YEAR | 115.39M | forecast_accuracy_snapshot | Forecast accuracy (handbook-derived) | OK | Matches spec and passes static rules |
| 16 | Pipeline Coverage by Stage | Report | 01aTb00000Cn85aIAB | 00OTb000008TZc5MAG | Pipeline Coverage by Stage | SUMMARY | THIS_QUARTER | 34.17M | pipeline_overview_global | Pipeline overview with quarterly focus | OK | Matches spec and passes static rules |
| 17 | Pipeline Overview by Stage | Report | 01aTb00000Cn9mPIAR | 00OTb000008fBfdMAE | P2.7 Pipeline Global This Qtr | SUMMARY | THIS_QUARTER | 51.42M | pipeline_overview_global | Pipeline overview with quarterly focus | OK | Matches spec and passes static rules |
| 18 | Renewal Pipeline This Quarter | Report | 01aTb00000Cn85ZIAR | 00OTb000008ektxMAA | Renewal Pipeline This Quarter | SUMMARY | THIS_QUARTER | 2.59M | pipeline_overview_global | Pipeline overview with quarterly focus | OK | Matches spec and passes static rules |
| 19 | Renewal ACV by Quarter | Report | 01aTb00000Cn85bIAB | 00OTb000008ekxBMAQ | Renewal ACV by Quarter | SUMMARY | THIS_YEAR | 11.04M | renewal_acv_this_quarter | Renewals tracking | OK | Matches spec and passes static rules |
| 20 | Renewal Likelihood by Probability | Report | 01aTb00000Cn9mRIAR | 00OTb000008fBULMA2 | P2.7 Renewal Likelihood This Qtr | SUMMARY | THIS_QUARTER | 2.59M | renewal_likelihood | Renewals tracking | OK | Matches spec and passes static rules |
| 21 | Renewals by Quarter | Report | 01aTb00000Cn85oIAB | 00OTb000008eksLMAQ | Renewals by Quarter | SUMMARY | THIS_YEAR | 15.09M | renewal_acv_this_quarter | Renewals tracking | OK | Matches spec and passes static rules |
| 22 | Close Date Slipped by Stage | Report | 01aTb00000Cn85lIAB | 00OTb000008eknVMAQ | Close Date Slipped CFQ Aging | SUMMARY | LAST_QUARTER | 1.58M | slipped_deals_root_cause | Slipped deals analysis | OK | Matches spec and passes static rules |
