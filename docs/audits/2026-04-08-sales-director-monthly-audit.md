...
- **Dashboard lastModifiedDate:** 2026-04-08T16:56:18Z
...
- **Tally:** 28 entries . 8 BLOCKING . 5 ORPHAN . 1 COSMETIC . 14 OK
...
| 9 | New Customers Won CFY | Report | 01aTb00000Cn85eIAB | 00OTb000008RfFNMA0 | New Customers Won CFY | SUMMARY | THIS_YEAR | 1.92M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 10 | Stage Duration CFY | Report | 01aTb00000Cn85nIAB | 00OTb000006ScDNMA0 | All open+won opps. FY26 | SUMMARY | THIS_YEAR | 84.01M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 11 | Top Accounts by ARR CFY | Report | 01aTb00000Cn85fIAB | 00OTb000008el21MAA | Top Accounts by ARR CFY | SUMMARY | THIS_YEAR | 321.76M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 12 | Win Rate Rolling 90d | Report | 01aTb00000Cn85mIAB | 00OTb000008RdyMMAS | Win Rate Rolling 90d | SUMMARY | LAST_N_DAYS:90 | 467 |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 13 | Win Rate by Quarter | Report | 01aTb00000Cn85kIAB | 00OTb000008TZdhMAG | Win Rate by Quarter | MATRIX | THIS_YEAR | 103.24M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 14 | Renewals by Fiscal Quarter | Report | 01aTb00000Cn85oIAB | 00OTb000008eksLMAQ | Renewals by Fiscal Quarter | SUMMARY | THIS_YEAR | 15.09M | renewal_acv_this_quarter | Renewals tracking | COSMETIC | Widget title contains the word 'fiscal': 'Renewals by Fiscal Quarter'. The brief requires calendar-year framing. |
| 15 | Business At Risk | Report | 01aTb00000Cn85dIAB | 00OTb000008Ta9xMAC | Business At Risk | SUMMARY | THIS_YEAR | 483.28M | churn_risk_placeholder | Churn Risk and trends | OK | Matches spec and passes static rules |
| 16 | Commercial Approval Candidates by Stage | Report | 01aTb00000Cn85jIAB | 00OTb000008ekp7MAA | Commercial Approval Candidates | SUMMARY | CUSTOM | 303.43M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 17 | Land Stage 3 Missing Approval by Region | Report | 01aTb00000Cn85hIAB | 00OTb000008ekltMAA | Land Stage 3 Missing Approval | SUMMARY | CUSTOM | 303.04M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 18 | New Customers (Land) by Region | Report | 01aTb00000Cn85cIAB | 00OTb000008ekqjMAA | New Customers (Land) by Region | SUMMARY | THIS_YEAR | 1.92M | land_stage3_no_approval_emea | Commercial Approval - Land Stage 3 missing approval | OK | Matches spec and passes static rules |
| 19 | Commercial Approval Approved YTD (Land) | Report | 01aTb00000Cn8FFIAZ | 00OTb000008aTtJMAU | Commercial Approval approved 2026 | SUMMARY | CUSTOM | 18.94M | commercial_approval_approved_ytd | Commercial Approval overview (global, YTD approved) | OK | Matches spec and passes static rules |
| 20 | Commercial Approval Global Current State | Report | 01aTb00000Cn9mQIAR | 00OTb000008fBEDMA2 | P2.7 Commercial Approval Global | SUMMARY | CUSTOM | 1.8K | commercial_approval_global | Commercial Approval overview (global, current state) | OK | Matches spec and passes static rules |
...
| 24 | Pipeline Overview Global by Stage (This Quarter) | Report | 01aTb00000Cn9mPIAR | 00OTb000008fBfdMAE | P2.7 Pipeline Global This Qtr | SUMMARY | THIS_QUARTER | 51.29M | pipeline_overview_global | Pipeline overview with quarterly focus | OK | Matches spec and passes static rules |
| 25 | Renewal Pipeline This Quarter | Report | 01aTb00000Cn85ZIAR | 00OTb000008ektxMAA | Renewal Pipeline This Quarter | SUMMARY | THIS_QUARTER | 2.59M | pipeline_overview_global | Pipeline overview with quarterly focus | OK | Matches spec and passes static rules |
| 26 | Renewal ACV by Quarter | Report | 01aTb00000Cn85bIAB | 00OTb000008ekxBMAQ | Renewal ACV by Quarter | SUMMARY | THIS_YEAR | 11.04M | renewal_acv_this_quarter | Renewals tracking | OK | Matches spec and passes static rules |
| 27 | Renewal Likelihood by Probability (This Quarter) | Report | 01aTb00000Cn9mRIAR | 00OTb000008fBULMA2 | P2.7 Renewal Likelihood This Qtr | SUMMARY | THIS_QUARTER | 2.59M | renewal_acv_this_quarter | Renewals tracking | OK | Matches spec and passes static rules |
| 28 | Close Date Slipped by Stage | Report | 01aTb00000Cn85lIAB | 00OTb000008eknVMAQ | Close Date Slipped CFQ Aging | SUMMARY | LAST_QUARTER | 58.57M | slipped_deals_root_cause | Slipped deals analysis | OK | Matches spec and passes static rules |
