...
- **Tally:** 35 entries . 23 BLOCKING . 7 WRONG-DATA . 5 ORPHAN
...
| 25 | Missing Amount on Open Opps | Report | 01aTb00000CmjwwIAB | 00OTb000008TZqcMAG | Missing Amount | TABULAR | THIS_FISCAL_YEAR | 768 |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
...
| 27 | Stale Opportunities | Report | 01aTb00000CmjwvIAB | 00OTb000008TZgvMAG | Stale Opportunities | TABULAR | THIS_FISCAL_YEAR | 1.3K |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 28 | Under Construction: Probability Mismatch by Stage | Report | 01aTb00000CmjwpIAB | 00OTb000008TaJdMAK | Probability Mismatch by Stage | SUMMARY | THIS_FISCAL_YEAR | 1036.03M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_YEAR but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 29 | Won Loss Info Missing CFQ | Report | 01aTb00000CmjwsIAB | 00OTb000008SqblMAC | Won/Loss Info Missing CFQ | SUMMARY | THIS_FISCAL_QUARTER | 3.45M |  | (orphan) | WRONG-DATA | (also orphan: widget does not map to any spec entry). Report standard date filter uses THIS_FISCAL_QUARTER but the KPI brief requires calendar year. Switch to a custom date filter that aligns to the current calendar quarter or year. |
| 30 | Aging Pipeline 365 Plus Days | Report | 01aTb00000CmjwqIAB | 00OTb000008Ti7VMAS | Aging Pipeline 365 Plus Days | SUMMARY | CUSTOM | 2156.82M | ph_aging_pipeline_365_plus | Pipeline hygiene (aging) | WRONG-DATA | Pipeline widget aggregates on standard AMOUNT (`AMOUNT`). Brief requires APTS_Opportunity_ARR__c for ARR. |
| 31 | High Value Stale Deals | Report | 01aTb00000Cmjx0IAB | 00OTb000008Ti97MAC | High Value Stale Deals | TABULAR | CUSTOM | 22.03M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 32 | KYC Not Completed | Report | 01aTb00000CmjwxIAB | 00OTb000007BvlJMAS | KYC Not Completed | SUMMARY | CUSTOM | 0 |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 33 | No Activity 30 Plus Days | Report | 01aTb00000CmjwyIAB | 00OTb000008TaEnMAK | No Activity 30+ Days — Open Opps | SUMMARY | THIS_YEAR | 146.45M |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 34 | Overdue Close Date Open Opps | Report | 01aTb00000CmjwtIAB | 00OTb000008TaBZMA0 | Overdue Close Date | TABULAR | CUSTOM | 107 |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
| 35 | Overdue Opportunities | Report | 01aTb00000CmjwoIAB | 00OTb000008SrmLMAS | Overdue Opportunities | SUMMARY | CUSTOM | 1.0K |  | (orphan) | ORPHAN | Dashboard widget does not map to any spec entry (likely cruft from BOB/RTB clone, or a legitimate context widget the spec does not account for). |
